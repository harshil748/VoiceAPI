...
const LANG_VOICE_MAP = {
  ...
  gujarati: { male: "gu_male", female: "gu_female" },
};

const LANG_SAMPLE_TEXT = {
  hindi: "नमस्ते, मैं आपकी कैसे मदद कर सकती हूँ?",
  bengali: "আমি কীভাবে আপনাকে সাহায্য করতে পারি?",
  marathi: "मी तुमची कशी मदद करू शकतो?",
  telugu: "నేను మీకు ఎలా సహాయం చేయగలను?",
  kannada: "ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು?",
  bhojpuri: "हम तोहार कइसे मदद कर सकत बानी?",
  chhattisgarhi: "मैं तुम्हारी कइसे मदद करे सकत हौं?",
  maithili: "हम अहाँक कोना मदद कए सकैत छी?",
  magahi: "हम तोरा केना मदद कर सकेला हई?",
  english: "hello, how can i help you today?",
  gujarati: "હું તમારી કઈ રીતે મદદ કરી શકું?",
};
...
export default function HomePage() {
  ...
  const [text, setText] = useState(LANG_SAMPLE_TEXT["hindi"]);
